...
public class DFS {
    ...
    public static void main(String[] args) {
        ...
        while (!jejak.isEmpty()) {
            ...
            Titik[] tetangga = getTetangga(center, arah);//depan | kanan | kiri | belakang
            Titik depan = tetangga[0];
            Titik kanan = tetangga[1];
            Titik kiri = tetangga[2];
            Titik belakang = tetangga[3];
    ...
    public static Titik[] getTetangga(Titik center, int arah) {
        int x = center.x;
        int y = center.y;

        Titik[] tetangga = new Titik[4];
        Titik depan = null;
        Titik kanan = null;
        Titik kiri = null;
        Titik belakang = null;
